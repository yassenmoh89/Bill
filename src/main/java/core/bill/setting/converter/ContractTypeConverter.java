...
public class ContractTypeConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		try {
			...
			if(contractBean !=null && contractBean.getContractTypeList() !=null && value!=null)
			{
				for(ContractTypeDTO obj :contractBean.getContractTypeList())
				{
					if(obj.getContractTypeId().equals(Long.valueOf(value)))
					{
						return obj ;
					}
				}
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if(value !=null)
		{
			return ((ContractTypeDTO)value).getContractTypeId().toString();
		}
		return null ;
	}
